...
visualizer = dict(
    ...
    vis_backends=[
        ...
        dict(type='WandbVisBackend'), # WanDB 연결
    ])
log_processor = dict(
...
# custom_imports 설정 - mmdet/datasets/transform/ 확인
# custom_imports = dict(
#     imports=['.work.custom.custom_aug'],  # custom transform이 정의된 파일 경로
...
load_pipeline = [
    ...
    dict(type='TrivialAugmentTransform', prob=0.5),  # TrivialAugment 커스텀 변환
    dict(
        type='RandomResize',
        scale=image_size,
        ratio_range=(0.1, 2.0),
