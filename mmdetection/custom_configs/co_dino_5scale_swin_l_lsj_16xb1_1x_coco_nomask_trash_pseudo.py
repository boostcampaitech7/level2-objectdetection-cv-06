...
load_from = '../checkpoints/co_dino_ms59_gamma3_img1380_12.pth'
load_pipeline = [
...
train_dataloader = dict(
    ...
    dataset=dict(
        _scope_='mmdet',
        dataset=dict(
            ann_file='json/merged_train_pseudo.json',
            backend_args=None,
            data_prefix=dict(img=''),
            data_root='../../dataset',
...
work_dir = '../work_dirs/co_dino_5scale_swin_l_lsj_16xb1_1x_coco_nomask_trash_pseudo'
