...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='/data/ephemeral/home/Dong_yeong/level2-objectdetection-cv-06/dataset',
        metainfo=dict(
            classes=(
                'General trash',
                'Paper',
...
train_cfg = dict(max_epochs=12, type='EpochBasedTrainLoop', val_interval=5)
...
work_dir = '../work_dirs/atss_swin_fpn_8xb8-amp-lsj-200e_trash'
